  ...
  return (
    <main className="min-h-screen">
      ...
      <article className="max-w-2xl mx-auto px-6 py-16 sm:py-24">
        ...
        <Section title="AGORA は、その問いに答える地図である">
          <P>
        ...
        <Section title="私たちが絶対にしないこと">
          <ul className="list-disc list-outside pl-6 space-y-3 text-marble-white/75 leading-relaxed">
...
function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <section className="mb-12">
      <h2 className="font-serif text-[24px] sm:text-[28px] text-marble-white mb-4 tracking-tight">
        {title}
      </h2>
...
function P({ children }: { children: React.ReactNode }) {
  return (
    <p className="text-[15px] sm:text-[16px] text-marble-white/80 leading-relaxed">{children}</p>
  );
}
